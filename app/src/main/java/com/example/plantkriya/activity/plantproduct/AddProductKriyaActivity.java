...
public class AddProductKriyaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_product_kriya);
    ...
    private void addMaterial() {
        ...
        if (image_uri == null) {
            ...
            reference.child("Material_Kriya").child(timestamp).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            //db updated
                            progressDialog.dismiss();
                            StyleableToast.makeText(AddProductKriyaActivity.this, "Material ditambahkan", Toast.LENGTH_SHORT).show();
                            clearData();
                        }
                    })
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            //failed updating db
                            progressDialog.dismiss();
                            StyleableToast.makeText(AddProductKriyaActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
