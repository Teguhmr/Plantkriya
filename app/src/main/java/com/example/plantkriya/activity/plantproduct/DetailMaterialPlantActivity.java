...
import com.example.plantkriya.activity.submissionplant.UploadSubmissionActivity;
...
public class DetailMaterialPlantActivity extends AppCompatActivity implements IFirebaseLoadDone, ValueEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_material_plant);
        ...
        detailReference = FirebaseDatabase.getInstance().getReference("Users").child("Material").child(materialId).child("detail_plant");
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.stop();
                Intent intent = new Intent(DetailMaterialPlantActivity.this, UploadSubmissionActivity.class);
