...
public class EditMaterialActivity extends AppCompatActivity {
    ...
    private void updateMaterial() {
        ...
        if (image_uri == null) {
            ...
            //save to db
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
            reference.child("Material").child(materialId).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            //db updated
                            progressDialog.dismiss();
                            StyleableToast.makeText(EditMaterialActivity.this, "Material diperbarui", Toast.LENGTH_SHORT).show();
                        }
                    })
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            //failed updating db
                            progressDialog.dismiss();
                            StyleableToast.makeText(EditMaterialActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
