...
public class DetailSubmissionReviewerKriyaActivity extends AppCompatActivity {
    ...
    private TextView tvSubmission, tvDate, tvTitle, tvCategory, tvStatus, tvName, tvEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_submission_reviewer_kriya);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                StyleableToast.makeText(DetailSubmissionReviewerKriyaActivity.this, "Diupdate", Toast.LENGTH_SHORT).show();
                inputData();
            }
        });
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            final DatabaseReference databaseReference1 = FirebaseDatabase.getInstance().getReference("Users")
                                    .child(uid);
                            databaseReference1.child("Submission_Kriya").child(submissionId).addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if (snapshot.exists()) {
                                        databaseReference1.child("Submission_Kriya").child(submissionId).updateChildren(hashMap);
                                    }
                                    finish();
