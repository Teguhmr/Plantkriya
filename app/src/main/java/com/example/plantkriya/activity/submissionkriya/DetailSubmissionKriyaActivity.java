...
public class DetailSubmissionKriyaActivity extends AppCompatActivity {
    private String submissionId;

    private ImageButton backBtn;
    private TextView tvSubmission, tvDate, tvTitle, tvCategory, tvStatus, tvName, tvEmail, tvNoteReviewer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_submission_kriya);
        ...
        picSubmission.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DetailSubmissionKriyaActivity.this);
...
//                                    convert Time
                                    ...
                                    try {
                                        ...
                                        picMaterial.setImageResource(R.drawable.pp3);
                                    }
                                    try {
                                        Picasso.get()
