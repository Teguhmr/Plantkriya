...
public class EditMaterialKriyaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_material_kriya);
        ...
        updateMaterialBtn = findViewById(R.id.btn_update);
        ...
        updateMaterialBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Flow
                //Input data
        ...
        reference.child("Material_Kriya").child(materialId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        String materialLevel = "" + snapshot.child("materialLevel").getValue();
                        String levelAvailable = "" + snapshot.child("levelAvailable").getValue();
                        String timestamp = "" + snapshot.child("timestamp").getValue();
                        String uid = "" + snapshot.child("uid").getValue();

                        if (levelAvailable.equals("true")) {
                        ...
                        titleEdt.setText(materialTitle);
                        descEdt.setText(materialDesc);
                        subtitleEdt.setText(materialSubtitle);
                        categoryTv.setText(materialCategory);
                        levelEdt.setText(materialLevel);
    ...
    private void updateMaterial() {
        ...
        if (image_uri == null) {
            ...
            //save to db
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
            reference.child("Material_Kriya").child(materialId).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            //db updated
                            progressDialog.dismiss();
                            StyleableToast.makeText(EditMaterialKriyaActivity.this, "Material diperbarui", Toast.LENGTH_SHORT).show();
                        }
                    })
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            //failed updating db
                            progressDialog.dismiss();
                            StyleableToast.makeText(EditMaterialKriyaActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            String filePathandName = "material_images/" + "" + materialId;
    ...
    private void categoryPlantDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Category")
                .setItems(Constants.kriyaCategory, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //get picked
                        String category = Constants.kriyaCategory[which];
                        //set picked
