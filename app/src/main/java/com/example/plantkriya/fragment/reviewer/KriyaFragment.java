...
import com.example.plantkriya.activity.ReviewerUserKriyaActivity;
import com.example.plantkriya.activity.plantproduct.AddProductKriyaActivity;
...
public class KriyaFragment extends Fragment {
    ...
    private TextView btnLogout, editProfileBtn, filteredMaterialTv, btnSubmssion;
    ...
    private ArrayList<ModelMaterialKriya> materialArrayList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSubmssion = view.findViewById(R.id.btn_submission);
        ...
        addproductFAB = view.findViewById(R.id.add_product);
        ...
        filteredMaterialBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Pilih Kategori")
                        .setItems(Constants.optionsCategory1, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                CharSequence selected = Constants.optionsCategory1[which];
        ...
        addproductFAB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), AddProductKriyaActivity.class));
            }
        });
...
//                startActivity(new Intent(getContext(), ProfileEditReviewerActivity.class));
        ...
        ClickableSpan clickablebtnSubmission = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View widget) {
                startActivity(new Intent(getContext(), ReviewerUserKriyaActivity.class));
            }
        ...
        ss3.setSpan(clickablebtnSubmission, 0, 10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        btnSubmssion.setText(ss3);
        btnSubmssion.setMovementMethod(LinkMovementMethod.getInstance());
    ...
    private void loadFilteredMaterial(final CharSequence selected) {
        ...
        databaseReference.child("Material_Kriya")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                            ...
                            final String materialCategory = "" + dataSnapshot.child("materialCategory").getValue();

                            if (selected.equals(materialCategory)) {
                                ModelMaterialKriya modelMaterial = dataSnapshot.getValue(ModelMaterialKriya.class);
                                materialArrayList.add(modelMaterial);
                            }

                        }
                        //setup adapter
                        materialPlantAdapter = new MaterialKriyaAdapter(getContext(), materialArrayList);
                        //set adapter
