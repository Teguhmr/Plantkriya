...
import com.example.plantkriya.activity.ReviewerUserActivity;
import com.example.plantkriya.activity.plantproduct.AddProductActivity;
...
//                startActivity(new Intent(getContext(), ProfileEditReviewerActivity.class));
        ...
        ClickableSpan clickablebtnSubmission = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View widget) {
                startActivity(new Intent(getContext(), ReviewerUserActivity.class));
            }
        ...
        databaseReference.child("Material")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        materialPlantAdapter = new MaterialPlantAdapter(getContext(), materialArrayList);
                        //set adapter
