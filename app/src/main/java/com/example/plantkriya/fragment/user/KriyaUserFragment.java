...
import com.example.plantkriya.activity.submissionkriya.SubmissionKriyaActivity;
...
public class KriyaUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kriya_user, container, false);
        // Set up the tool bar
        setUpToolbar(view);
        ...
        rvMaterial = view.findViewById(R.id.rv_material_kriya);
                ...
                builder.setTitle("Pilih Kategori")
                        .setItems(Constants.kriyaCategory, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                CharSequence selected = Constants.kriyaCategory[which];
...
//                startActivity(new Intent(getContext(), ProfileEditReviewerActivity.class));
        ...
        ClickableSpan clickableSpanSubmission = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View widget) {
                startActivity(new Intent(getContext(), SubmissionKriyaActivity.class));
            }
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                            ...
                            final String materialCategory = "" + dataSnapshot.child("materialCategoryKriya").getValue();
                        ...
                        //setup adapter
                        materialPlantAdapter = new MaterialKriyaUserAdapter(getContext(), materialArrayList);
                        //set adapter
...
//        final boolean isDialogClose = type == ALERT_DIALOG_CLOSE;
    ...
    private void setUpToolbar(View view) {
        ...
        toolbar.setNavigationOnClickListener(new NavigationIconClickListener(
                ...
                getContext().getResources().getDrawable(R.drawable.ic_kriyaiconnavdraw),
