...
import com.example.plantkriya.activity.DetailSubmissionReviewerKriyaActivity;
import com.example.plantkriya.filter.FilterSubmissionReviewerKriya;
import com.example.plantkriya.model.ModelSubmissionUserForReviewerKriya;

import java.util.ArrayList;
import java.util.Calendar;

public class AdapterSubmissionUserForReviewerKriya extends RecyclerView.Adapter<AdapterSubmissionUserForReviewerKriya.HolderSubmissionReviewer>
        implements Filterable {

    public ArrayList<ModelSubmissionUserForReviewerKriya> submissionUserForReviewerArrayList, filterList;
    private Context context;
    private FilterSubmissionReviewerKriya filter;

    public AdapterSubmissionUserForReviewerKriya(Context context, ArrayList<ModelSubmissionUserForReviewerKriya> submissionUserForReviewerArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderSubmissionReviewer holder, int position) {
        ModelSubmissionUserForReviewerKriya modelSubmissionUserForReviewer = submissionUserForReviewerArrayList.get(position);
        ...
        String category = modelSubmissionUserForReviewer.getMaterialCategoryKriya();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetailSubmissionReviewerKriyaActivity.class);
    ...
    public Filter getFilter() {
        if (filter == null) {
            //init filter
            filter = new FilterSubmissionReviewerKriya(this, filterList);
        }
        return filter;
    }
