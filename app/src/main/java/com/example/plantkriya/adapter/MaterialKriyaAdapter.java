...
import com.example.plantkriya.activity.plantproduct.EditMaterialKriyaActivity;
import com.example.plantkriya.filter.FilterMaterialKriya;
...
public class MaterialKriyaAdapter extends RecyclerView.Adapter<MaterialKriyaAdapter.MaterialViewHolder>
        implements Filterable {

    public ArrayList<ModelMaterialKriya> modelMaterialArrayList, filterList;
    private Context context;
    private FilterMaterialKriya filterMaterial;

    public MaterialKriyaAdapter(Context context, ArrayList<ModelMaterialKriya> modelMaterialArrayList) {
    ...
    @NonNull
    @Override
    public MaterialKriyaAdapter.MaterialViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MaterialKriyaAdapter.MaterialViewHolder holder, int position) {
        final ModelMaterialKriya modelMaterial = modelMaterialArrayList.get(position);
...
//            holder.subtitleTv.setPaintFlags(holder.subtitleTv.getPaintFlags()| Paint.STRIKE_THRU_TEXT_FLAG);
    ...
    private void detailBottomSheet(ModelMaterialKriya modelMaterial) {
...
//            holder.subtitleTv.setPaintFlags(holder.subtitleTv.getPaintFlags()| Paint.STRIKE_THRU_TEXT_FLAG);
        ...
        btnChange.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, EditMaterialKriyaActivity.class);
    ...
    private void deleteMaterial(String id) {
        ...
        reference.child("Material_Kriya").child(id).removeValue()
    ...
    public Filter getFilter() {
        if (filterMaterial == null) {
            filterMaterial = new FilterMaterialKriya(this, filterList);
