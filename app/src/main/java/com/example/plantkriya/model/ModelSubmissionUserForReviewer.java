...
public class ModelSubmissionUserForReviewer {

    String submissionId, submissionTime, materialTitle, materialCategoryPlant, submissionStatus,
            emailProfile, nameProfile;

    public ModelSubmissionUserForReviewer() {
    }

    public ModelSubmissionUserForReviewer(String submissionId, String submissionTime, String materialTitle, String materialCategoryPlant, String submissionStatus, String emailProfile, String nameProfile) {
