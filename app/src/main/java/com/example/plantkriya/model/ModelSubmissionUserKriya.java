...
public class ModelSubmissionUserKriya {

    String submissionId, submissionTime, materialTitle, materialCategoryKriya, submissionStatus,
            emailProfile, nameProfile;

    public ModelSubmissionUserKriya() {
    }

    public ModelSubmissionUserKriya(String submissionId, String submissionTime, String materialTitle, String materialCategoryKriya, String submissionStatus, String emailProfile, String nameProfile) {
